...
#if defined(NDEBUG)
# error "Boodle cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Boodle Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
		nSubsidy = 200000000 * COIN;  // 200mil
    } 
...
#ifdef ENABLE_WALLET
// Boodle: attempt to generate suitable proof-of-stake
